...
class AcademyTest {
    ...
    fun toDetailActivityTest() {
        ...
        onView(withId(R.id.rv_academy)).perform(actionOnItemAtPosition<RecyclerView.ViewHolder>(0, click()))
    ...
    fun toReaderActivityTest() {
        ...
        onView(withId(R.id.rv_module)).perform(actionOnItemAtPosition<RecyclerView.ViewHolder>(0, click()))
